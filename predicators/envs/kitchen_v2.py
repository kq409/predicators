...
README of that repo suggests!"
    ...
    def create_predicates(cls) -> Dict[str, Predicate]:
        ...
        preds = {
            ...
            Predicate("IsKeycardTable", [cls.site_type], cls._IsKeycardTable_holds),
            Predicate("IsCounterTop", [cls.site_type], cls._IsCounterTop_holds),
            Predicate("KeycardAt", [cls.grippable_object_type, cls.site_type], cls._KeycardAt_holds),
    ...
    def set_object_positions_override(self, object_positions):
        ...
        object_positions should be a list of 4 or 5 [x, y, z] lists in the
        order [\"mug\", \"milk\", \"sponge\", \"tea\", \"keycard\"]
    ...
    def _setup_new_objects(self, seed: int, train_or_test: str) -> None:
        ...
        object_names = ["mug", "milk", "sponge", "tea", "keycard"]
        # Backward compatibility: allow legacy 4-object overrides.
