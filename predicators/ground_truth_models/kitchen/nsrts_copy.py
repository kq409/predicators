...
class KitchenGroundTruthNSRTFactory(GroundTruthNSRTFactory):
    ...
    def get_nsrts(env_name: str, types: Dict[str, Type],
        ...
        # Here we do NOT restrict which container can contain which object; MugFound/TeaFound are added for any container.
        ...
        # Assume always find banana, mug, sponge, and tea during planning (optimistic planning)
        add_effects = {
